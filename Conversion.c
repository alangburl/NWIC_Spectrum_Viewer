 ...
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_channel.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_channel.shape[0])) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 17, __pyx_L1_error)
    }
    *((double *) ( /* dim=0 */ (__pyx_v_channel.data + __pyx_t_11 * __pyx_v_channel.strides[0]) )) = __pyx_t_10;
  }
